...
#    t.add("&", "&")
    ...
    t.add("&LPAR;",      "(")
    t.add("&DAGGER;",	u"\u2020")
    #t.add("&DAGGER;",	u"\u0000")  #PJB 2015-05-11, not a good idea (gives ^@)
    # (or just remove &DAGGER; from text before feeding into the converter...)
    ...
    # BS4 converts html entities to utf-8 characters which choke the Trie,
...
if __name__ == "__main__":
    print( "Trie based betacode -> utf8 converter" )
